...
def test_tf_sums_1_1000():
    ...
    assert result['divisible_by_three'] == 166833               # b = lambda x : sum(range(0, x, 3)), c(1000) = 166833
    assert result['divisible_by_five'] == 99500                 # c = lambda x : sum(range(0, x, 5)), b(1000) = 99500
    assert result['divisible_by_three_and_five'] == 33165       # d = lambda x : sum(range(0, x, 15)), d(1000) = 33165
